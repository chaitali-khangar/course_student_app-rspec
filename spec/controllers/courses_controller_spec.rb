...
RSpec.describe CoursesController, type: :controller do
  ...
  describe "GET #index" do
    it "returns a success response" do
      ...
      # @courses is a variable name which we have used in controller action that same name we have given in assign
      expect(assigns(:courses)).to eq([course])
      # this one has template index in app/views/coures/index.html.erb thats what we are checking here
  ...
  describe "GET #edit" do
    it "returns a success response" do
      ...
      expect(response).to be_successful
      # @course is a variable name which we have used in controller action that same name we have given in assign
      expect(assigns(:course)).to eq(course)
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Course" do
        ...
        # if create is successful then it redirect to show url i.e. /courses/:id that the reason we are checking redirect here. To know routes we can use "rake routes" command
        expect(response).to redirect_to("/courses/#{Course.last.id}")
        expect(assigns(:course).name).to eq("Rspec")
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested course" do
        ...
        course.reload
        expect(course.name).to eq("Rails")
      end
